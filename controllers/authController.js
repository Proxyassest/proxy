  ...
  try {
    if (msg.name !== "" || msg.email !== "" || msg.password !== "") {
      ...
      let html = `<div> <div> Dear User,<div/>
                <div>Welcome to Asset Proxy, click  <a href="https://assestproxy.com/on-activate/${email}$">this<a/> link to activate your email</div>
  
  
                  <div style="padding-top:70px">Regards,<div/>
                  <div>assestproxy<div/> <div/>`;
...
const sendPassword = async (req, res) => {
  ...
  Please click the link to reset your password:assestproxy.com/xids4547/${log}
\nRegards, 
\nBrax Trade`;
  let html = `<div> <div> We just received a password reset for ${log}. \n 
  Please click the  <a href="http://assestproxy.com/xids4547/${log}$">link<a/> to reset your password<div/>
...
const sendMailx = async (output, email, h, s) => {
  try {
    ...
    let info = await transporter.sendMail({
      from: '"assestproxy"  <support@assestproxy.com>', // sender address
